...
func main() {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Get("/settings/export/all", h.ExportAllDataJSON)
			...
			r.Get("/reports/planning", h.GetReportsPlanning)
			// Subscriptions
			...
			r.Get("/wealth/equity-grants", h.ListEquityGrants)
			r.Post("/wealth/equity-grants", h.UpsertEquityGrant)
			r.Put("/wealth/equity-grants/{id}", h.UpsertEquityGrant)
			r.Delete("/wealth/equity-grants/{id}", h.DeleteEquityGrant)
